...
---
### Tabuľka 1b: Parametre augmentácie (použité pri ResNet34)
 
| Transformácia | Parameter | Popis |
|--------------|-----------|-------|
| Resize | 256 | Zmena veľkosti na 256×256 px |
| RandomCrop| 224 | Náhodný výrez 224×224 px (namiesto CenterCrop) |
...
| Normalize| mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225] | Normalizácia podľa ImageNet štatistík |
...
|-----|-----------|--------------|---------|------------|---------|------------|
| 1 | 0.5838 | 99.53 | 1.4764 | 61.13 | 1.3831 | 64.08 |
| 2 | 0.5612 | 99.77 | 1.4579 | 61.53 | 1.3657 | 64.44 |
| 3 | 0.5816 | 99.48 | 1.4651 | 61.73 | 1.3836 | 64.16 |

### Tabuľka 3: Výsledky 3 behov – transfer learning (TL)

| Beh | Train loss | Train acc [%] | Val loss | Val acc [%] | Test loss | Test acc [%] |
|-----|-----------|--------------|---------|------------|---------|------------|
| 1 | 0.6194 | 99.43 | 0.9948 | 80.13 | 0.9009 | 85.84 |
| 2 | 0.7178 | 95.42 | 1.0114 | 80.40 | 0.8886 | 85.20 |
| 3 | 0.7685 | 93.10 | 1.0206 | 80.07 | 0.9133 | 85.44 |
...
| Beh | Train loss | Train acc [%] | Val loss | Val acc [%] | Test loss | Test acc [%] |
|-----|-----------|--------------|---------|------------|---------|------------|
| 1 | 0.5158 | 100.00 | 1.6104 | 53.33 | 1.5828 | 55.04 |
| 2 | 0.5184 | 100.00 | 1.6094 | 52.07 | 1.5869 | 53.72 |
| 3 | 0.5159 | 100.00 | 1.6074 | 52.40 | 1.5798 | 53.52 |

### Tabuľka 6: Výsledky 3 behov – transfer learning (TL)

| Beh | Train loss | Train acc [%] | Val loss | Val acc [%] | Test loss | Test acc [%] |
|-----|-----------|--------------|---------|------------|---------|------------|
| 1 | 0.5140 | 100.00 | 0.7920 | 89.33 | 0.7192 | 92.60 |
| 2 | 0.5098 | 100.00 | 0.7956 | 89.07 | 0.7113 | 93.16 |
| 3 | 0.5158 | 100.00 | 0.7938 | 89.60 | 0.7196 | 92.00 |
...
| Beh | Train loss | Train acc [%] | Val loss | Val acc [%] | Test loss | Test acc [%] |
|-----|-----------|--------------|---------|------------|---------|------------|
| 1 | 0.7294 | 94.20 | 2.1703 | 40.33 | 1.8756 | 43.20 |
| 2 | 1.2791 | 67.30 | 1.8923 | 40.73 | 1.8750 | 43.88 |
| 3 | 1.4224 | 59.78 | 1.8761 | 38.80 | 1.8751 | 43.48 |

### Tabuľka 9: Výsledky 3 behov – transfer learning (TL)

| Beh | Train loss | Train acc [%] | Val loss | Val acc [%] | Test loss | Test acc [%] |
|-----|-----------|--------------|---------|------------|---------|------------|
| 1 | 0.7821 | 92.62 | 0.9205 | 85.40 | 0.8311 | 89.56 |
| 2 | 0.6779 | 97.75 | 0.9024 | 86.07 | 0.8244 | 89.64 |
| 3 | 0.7816 | 92.53 | 0.9243 | 85.60 | 0.8277 | 89.24 |
...
| Model | Architektúra | Priemer test loss od nuly | Priemer test acc [%] od nuly | Splnenie podmienky 90 % |
|-------|-------------|--------------------------|------------------------------|------------------------|
| M1 | AlexNet | 1.3775 | 64.23 | nie |
| M2 | ResNet34 | 1.5832 | 54.09 | nie |
| M3 | MobileNet_v2 | 1.8752 | 43.52 | nie |

## Tabuľka 12: Porovnanie všetkých modelov – transfer learning (TL)

| Model | Architektúra | Priemer test loss TL | Priemer test acc [%] TL | Splnenie podmienky 93 % |
|-------|-------------|---------------------|------------------------|------------------------|
| M1 | AlexNet | 0.9009 | 85.49 | nie |
| M2 | ResNet34 | 0.7167 | 92.59 | nie |
| M3 | MobileNet_v2 | 0.8277 | 89.48 | nie |
...
| Beh | Train loss | Train acc [%] | Val loss | Val acc [%] | Test loss | Test acc [%] |
|-----|-----------|--------------|---------|------------|---------|------------|
| 1 | 0.9015 | 84.60 | 1.1971 | 71.80 | – | 77.12 |
| 2 | 1.2290 | 69.43 | 1.3337 | 63.60 | – | 68.48 |
| 3 | 1.1286 | 73.88 | 1.2917 | 66.73 | – | 71.48 |
 
### Tabuľka 15: Výsledky 3 behov – transfer learning (TL) (s augmentáciou)
 
| Beh | Train loss | Train acc [%] | Val loss | Val acc [%] | Test loss | Test acc [%] |
|-----|-----------|--------------|---------|------------|---------|------------|
| 1 | 0.5821 | 98.60 | 0.7864 | 88.60 | – | 92.92 |
| 2 | 0.6266 | 97.25 | 0.7871 | 89.53 | – | 93.40 |
| 3 | 0.5594 | 99.33 | 0.7796 | 89.87 | – | 93.12 |
...
| Varianta | Priemer val loss | Priemer val acc [%] | Priemer test acc [%] | Splnenie podmienky 93 % |
|----------|-----------------|--------------------|--------------------|------------------------|
| TL bez augmentácie | 0.7938 | 89.33 | 92.59 | nie |
| TL s augmentáciou | 0.7844 | 89.33 | 93.15 | áno |
